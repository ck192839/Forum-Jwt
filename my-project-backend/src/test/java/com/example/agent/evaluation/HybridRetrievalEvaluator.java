...
final class HybridRetrievalEvaluator {
    ...
    List<RetrievalCaseEvaluation> evaluate(AgentEvaluationDataset dataset) {
        List<RetrievalCaseEvaluation> results = new ArrayList<>();
        for (AgentEvaluationDataset.RetrievalCase testCase : dataset.retrievalCases()) {
    ...
    private RetrievalCaseEvaluation failed(
            AgentEvaluationDataset.RetrievalCase testCase,
            Instant started,
